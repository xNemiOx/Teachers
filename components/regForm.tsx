                    ...
                    <div className='pt-5 space-y-8 pb-8'>
                        ...
                        <div className="flex justify-between w-72 pl-20">
                            <div className="flex justify-center relative">
                                ...
                                <label for="default-radio-1" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Я ученик</label>
                            </div>
                            <div className="flex justify-center relative">
                                ...
                                <label for="default-radio-2" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Я репетитор</label>
                            </div>
                        </div>
                    </div>
