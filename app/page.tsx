  ...
  return (
    <div>
      ...
      <main className="relative flex min-h-screen flex-col items-center justify-star">
        ...
        <div className="bg-secondary z-50 w-full h-[720px] flex justify-center">

          <div className='w-1/3 z-50 flex items-center flex-col py-40'>
            <p className='text-5xl text-text font-bold mb-10'>Всё в одном месте:</p>
            <p className='text-2xl text-text text-center'>Интернет-ресурс "Развитие" собрал в себе все необходимые функции для репетиторского центра от поиска эксперта и ученика до чатов с ним</p>
            <a href="#" className="text-text font-bold text-base bg-accent border-white rounded-3xl py-3 px-6 mt-16">Зарегистрироваться</a>
          </div>
      ...
      <footer>
        <div className="bg-background z-50 w-full h-screen flex justify-center">
          ...
          <div className='w-3/4 z-50 flex items-center flex-col py-36'>
            ...
            <a href="#" className="text-black font-bold text-base bg-primary border-white rounded-3xl py-3 px-6 mt-16">Зарегистрироваться</a>
